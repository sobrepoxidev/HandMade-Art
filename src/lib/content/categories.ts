...
export const CATEGORIES: CategoryContent[] = [
  ...
  },
  {
    ...
    intro: {
      es: [
        "Nuestros juegos de cocina de madera combinan función y artesanía: utensilios tallados a mano en cedro costarricense, pensados para usarse todos los días y no solo para exhibir. Cada set es trabajado por artesanos del programa de reinserción social en San Isidro de Coronado, San José, con un acabado en barniz natural que resiste el uso diario en la cocina. Incluyen desde cucharones y espátulas hasta tablas y soportes, siempre con el grano de la madera visible en cada pieza.",
      ...
      en: [
        "Our wooden kitchen sets combine function and craft: utensils hand-carved from Costa Rican cedar, made to be used every day, not just displayed. Each set is made by artisans in the social reintegration program in San Isidro de Coronado, San José, finished with a natural varnish that holds up to daily kitchen use. They range from spoons and spatulas to boards and stands, each one showing the natural wood grain.",
  ...
  },
  {
    ...
    intro: {
      es: [
        "Un espejo tallado en madera es una de las piezas más pedidas de nuestro taller: el marco se talla a mano en cedro costarricense, con motivos que van de líneas geométricas simples a diseños inspirados en la fauna y flora del país. Cada espejo lo produce un artesano del programa de reinserción social en San Isidro de Coronado, San José, así que las variaciones naturales de la madera hacen que cada pieza sea única.",
      ...
      en: [
        "A hand-carved wooden mirror is one of our workshop's most requested pieces: the frame is carved by hand from Costa Rican cedar, with motifs ranging from simple geometric lines to designs inspired by the country's wildlife and plants. Every mirror is made by an artisan in the social reintegration program in San Isidro de Coronado, San José, so the wood's natural variation makes each piece one of a kind.",
  ...
  },
  {
    ...
    intro: {
      es: [
        "Esta colección reúne piezas de decoración hechas a mano que no encajan en una sola categoría: detalles en madera tallada, acabados en cedro costarricense y toques inspirados en la naturaleza tropical del país. Cada objeto sale del taller de artesanos en proceso de reinserción social en San Isidro de Coronado, San José, con el mismo cuidado en el tallado y el barniz que el resto de nuestra colección.",
      ...
      en: [
        "This collection brings together handmade décor pieces that don't fit neatly into one category: carved wood details, Costa Rican cedar finishes, and touches inspired by the country's tropical nature. Every object comes out of the workshop of artisans in a social reintegration process in San Isidro de Coronado, San José, with the same care in the carving and varnish as the rest of our collection.",
  ...
  },
  {
    ...
    intro: {
      ...
      en: [
        "Our paintings are original pieces made by hand by artisans in the social reintegration program in San Isidro de Coronado, San José, with color palettes and scenes inspired by Costa Rica's landscapes, towns and wildlife. These aren't printed reproductions — each canvas has its own brushwork and detail, so no two paintings are exactly alike. We work in small formats for tight spaces and larger pieces for a statement wall.",
  ...
  },
  {
    ...
    intro: {
      es: [
        "Cada escultura de madera de nuestra colección se talla a mano, bloque por bloque, por artesanos del programa de reinserción social en San Isidro de Coronado, San José. Muchas piezas están inspiradas en la fauna costarricense —tucanes, colibríes, ranas de ojos rojos, quetzales— y otras en formas abstractas o utilitarias, siempre trabajadas en cedro y otras maderas locales. El proceso puede tomar varios días por pieza según el nivel de detalle del tallado.",
      ...
      en: [
        "Every wood sculpture in this collection is carved by hand, block by block, by artisans in the social reintegration program in San Isidro de Coronado, San José. Many pieces are inspired by Costa Rican wildlife — toucans, hummingbirds, red-eyed tree frogs, quetzals — while others are abstract or utilitarian shapes, always worked in cedar and other local woods. The carving process can take several days per piece depending on the level of detail.",
  ...
  },
  {
    ...
    intro: {
      ...
      en: [
        "The wooden boxes in this collection are small but carefully made: hand-carved lids and sides, functional hinges, and a smooth interior ready to hold jewelry, letters or any small keepsake. They're made by artisans in the social reintegration program in San Isidro de Coronado, San José, with the same care in the varnish as the rest of the collection.",
  ...
  },
  {
    ...
    intro: {
      es: [
        "Nuestros servilleteros de madera son piezas pequeñas de uso diario, talladas a mano en cedro costarricense por artesanos del programa de reinserción social en San Isidro de Coronado, San José. Son un detalle sencillo que le da un toque artesanal a la mesa de todos los días sin perder funcionalidad, con el mismo acabado en barniz natural de nuestras piezas más grandes.",
      ...
      en: [
        "Our wooden napkin holders are small, everyday pieces, hand-carved from Costa Rican cedar by artisans in the social reintegration program in San Isidro de Coronado, San José. They're a simple detail that brings a handmade touch to the daily table without losing functionality, finished with the same natural varnish as our larger pieces.",
  ...
  },
  {
    ...
    intro: {
      es: [
        "Nuestras tazas son de peltre esmaltado (enamel), pintadas a mano una por una por artesanos del programa de reinserción social en San Isidro de Coronado, San José. Es el mismo tipo de taza resistente que se usa en fincas de café y campamentos, pero con diseños originales que no vas a encontrar en una tienda de recuerdos genérica.",
      ...
      en: [
        "Our mugs are hand-painted enamel, painted one by one by artisans in the social reintegration program in San Isidro de Coronado, San José. It's the same sturdy enamelware used on coffee farms and camping trips, but with original designs you won't find in a generic souvenir shop. The enamel coating resists chips better than plain ceramic, so it travels well too.",
  ...
  },
  {
    ...
    intro: {
      es: [
        "Los instrumentos musicales de nuestra colección se trabajan a mano en madera por artesanos del programa de reinserción social en San Isidro de Coronado, San José, combinando tradición costarricense con acabados cuidados para que suenen bien y también luzcan bien como pieza decorativa. Cada instrumento pasa por un proceso de selección de madera antes de empezar el tallado.",
      ...
      en: [
        "The musical instruments in this collection are hand-worked in wood by artisans in the social reintegration program in San Isidro de Coronado, San José, combining Costa Rican tradition with careful finishing so they both sound good and look good as a decorative piece. Each instrument goes through a wood-selection step before the carving even begins.",
