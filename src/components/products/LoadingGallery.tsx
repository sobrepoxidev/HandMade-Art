...
function SkeletonCard() {
  return (
    <div className="flex h-full flex-col overflow-hidden rounded-sm border border-[#E8E4E0] bg-[#FAF6EF]">
      <div className="relative h-48 w-full overflow-hidden bg-[#F5F1EB]" style={{ aspectRatio: '4/3' }}>
      ...
      <div className="flex flex-grow animate-pulse flex-col p-3">
        ...
        <div className="flex justify-center items-center mt-2">
          <div className="mx-auto mb-2 flex h-10 w-3/6 flex-row items-center overflow-hidden rounded-sm border border-[#E8E4E0]">
        ...
        <div className="mx-auto mt-auto h-10 w-3/6 rounded-sm bg-[#D4C4A8]"></div>
      </div>
    </div>
  );
}
