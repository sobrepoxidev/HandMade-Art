      ...
      <div className="container mx-auto max-w-7xl">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-10">
          ...
          <div className="space-y-5">
            <div className="flex items-center" aria-label="HandMade Art">
              <Heart className="h-7 w-7 text-[#C9A962] mr-2" aria-hidden />
            ...
            <p className="text-[#B5AC9D] text-sm leading-relaxed">
              {locale === 'es'
            ...
            <ul className="space-y-4">
              <li>
                <a
                  ...
                  className="flex items-center text-[#B5AC9D] hover:text-[#C9A962] transition-colors duration-300 group"
                >
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li>
                <Link href="/products" className="text-[#B5AC9D] hover:text-[#C9A962] transition-colors duration-300 text-sm">
                  {locale === 'es' ? 'Productos' : 'Products'}
                </Link>
              </li>
              <li>
                <Link href="/about" className="text-[#B5AC9D] hover:text-[#C9A962] transition-colors duration-300 text-sm">
                  {locale === 'es' ? 'Nosotros' : 'About Us'}
                </Link>
              </li>
              <li>
                <Link href="/contact" className="text-[#B5AC9D] hover:text-[#C9A962] transition-colors duration-300 text-sm">
                  {locale === 'es' ? 'Contacto' : 'Contact'}
                </Link>
              </li>
              <li>
                <Link href="/privacy-policies" className="text-[#B5AC9D] hover:text-[#C9A962] transition-colors duration-300 text-sm">
                  {locale === 'es' ? 'Políticas de Privacidad' : 'Privacy Policies'}
                </Link>
              </li>
              <li>
                <Link href="/conditions-service" className="text-[#B5AC9D] hover:text-[#C9A962] transition-colors duration-300 text-sm">
          ...
          <div>
            ...
            <div className="flex flex-wrap gap-3">
              <a
                ...
                className="grid place-items-center w-11 h-11 bg-[#2D2D2D] hover:bg-[#C9A962] rounded-sm transition-colors duration-300 group border border-[#C9A962]/25 hover:border-[#C9A962]"
                aria-label="Facebook"
              >
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="grid place-items-center w-11 h-11 bg-[#2D2D2D] hover:bg-[#25D366] rounded-sm transition-colors duration-300 group border border-[#C9A962]/25 hover:border-[#25D366]"
                aria-label="WhatsApp (abre en una nueva ventana)"
              >
        ...
        <div className="text-center">
          ...
          <p className="text-[.65rem] text-[#4A4A4A] flex flex-wrap items-center justify-center gap-1">
            ...
            <Link
              ...
              target="_blank"
              rel="author noopener noreferrer"
              className="text-[#B5AC9D]/70 hover:text-[#B5AC9D] transition-colors inline-flex items-center gap-1"
            >
              Bryam López
              <ExternalLink className="w-2.5 h-2.5" />
            </Link>
