...
export default async function FiestasSanRamonPage({ params }: { params: tParams }) {
  ...
  return (
    <main className="min-h-screen bg-[#161210] text-[#F1E7D6]">
      ...
      <section className="relative h-64 bg-[#0F0C0A] text-[#F1E7D6] border-b border-[#3A2E24]">
        <div className="container mx-auto h-full flex flex-col justify-center px-4">
          <h1 className="font-display text-4xl md:text-5xl font-bold mb-4 text-[#F1E7D6]">{locale === 'es' ? 'Fiestas Patronales de San Ramón 2025' : 'San Ramón Patronal Festivities 2025'}</h1>
          <p className="text-xl mb-8 text-[#E0A83A] font-medium">{locale === 'es' ? '21 al 31 de Agosto - Celebrando 100 años de tradición' : 'August 21-31 - Celebrating 100 years of tradition'}</p>
      ...
      <section className="py-6 container mx-auto px-4">
        <h2 className="font-display text-3xl font-bold mb-4 text-center text-[#F1E7D6]">{locale === 'es' ? 'Eventos y Actividades' : 'Events and Activities'}</h2>

        {/* Programación completa por días */}
        <div className="space-y-3">
          {/* Jueves 21 de agosto */}
          <div className="bg-[#1E1813] border border-[#3A2E24] rounded-sm shadow-[0_8px_24px_-12px_rgba(0,0,0,0.4)] p-4 sm:p-6">
            <h3 className="font-display text-xl sm:text-2xl font-semibold mb-4 text-[#F1E7D6] border-b border-[#3A2E24] pb-2">
              {locale === 'es' ? 'Jueves 21 de agosto (2025)' : 'Thursday, August 21 (2025)'}
            </h3>
            <div className="grid gap-3 text-sm sm:text-base">
              <div className="flex flex-col sm:flex-row sm:items-center gap-1 sm:gap-3">
                <span className="bg-[#E0A83A] text-[#161210] rounded-sm px-2 py-1 font-bold text-xs sm:text-sm w-fit">7:00 am</span>
                <span>{locale === 'es' ? 'Santa Misa en el Centro' : 'Holy Mass at the Center'}</span>
              </div>
              <div className="flex flex-col sm:flex-row sm:items-center gap-1 sm:gap-3">
                <span className="bg-[#E0A83A] text-[#161210] rounded-sm px-2 py-1 font-bold text-xs sm:text-sm w-fit">9:00 am</span>
              ...
              <div className="flex flex-col sm:flex-row sm:items-center gap-1 sm:gap-3">
                <span className="bg-[#E0A83A] text-[#161210] rounded-sm px-2 py-1 font-bold text-xs sm:text-sm w-fit">10:00 am</span>
                <span>{locale === 'es' ? 'Hora Santa por las Embarazadas' : 'Holy Hour for Pregnant Women'}</span>
              </div>
              <div className="flex flex-col sm:flex-row sm:items-center gap-1 sm:gap-3">
                <span className="bg-[#E0A83A] text-[#161210] rounded-sm px-2 py-1 font-bold text-xs sm:text-sm w-fit">2:00 pm</span>
                <span>{locale === 'es' ? 'Bingo Pesetero' : 'Bingo Game'}</span>
              </div>
              <div className="flex flex-col sm:flex-row sm:items-center gap-1 sm:gap-3">
                <span className="bg-[#E0A83A] text-[#161210] rounded-sm px-2 py-1 font-bold text-xs sm:text-sm w-fit">6:00 pm</span>
                <span>{locale === 'es' ? 'Santa Misa en el Centro' : 'Holy Mass at the Center'}</span>
              </div>
              <div className="flex flex-col sm:flex-row sm:items-center gap-1 sm:gap-3">
                <span className="bg-[#E0A83A] text-[#161210] rounded-sm px-2 py-1 font-bold text-xs sm:text-sm w-fit">7:00 pm</span>
              ...
              <div className="flex flex-col sm:flex-row sm:items-center gap-1 sm:gap-3">
                <span className="bg-[#E0A83A] text-[#161210] rounded-sm px-2 py-1 font-bold text-xs sm:text-sm w-fit">8:00 pm</span>
          ...
          <div className="bg-[#1E1813] border border-[#3A2E24] rounded-sm shadow-[0_8px_24px_-12px_rgba(0,0,0,0.4)] p-4 sm:p-6">
            ...
            <div className="grid gap-3 text-sm sm:text-base">
              ...
              <div className="flex flex-col sm:flex-row sm:items-center gap-1 sm:gap-3">
                <span className="bg-[#E0A83A] text-[#161210] rounded-sm px-2 py-1 font-bold text-xs sm:text-sm w-fit">4:00 pm</span>
                <span>{locale === 'es' ? 'Monchitour' : 'Monchitour'}</span>
              </div>
              <div className="flex flex-col sm:flex-row sm:items-center gap-1 sm:gap-3">
                <span className="bg-[#E0A83A] text-[#161210] rounded-sm px-2 py-1 font-bold text-xs sm:text-sm w-fit">5:00 pm</span>
          ...
          <div className="bg-[#1E1813] border border-[#3A2E24] rounded-sm shadow-[0_8px_24px_-12px_rgba(0,0,0,0.4)] p-4 sm:p-6">
            ...
            <div className="grid gap-3 text-sm sm:text-base">
              ...
              <div className="flex flex-col sm:flex-row sm:items-center gap-1 sm:gap-3">
                <span className="bg-[#E0A83A] text-[#161210] rounded-sm px-2 py-1 font-bold text-xs sm:text-sm w-fit">11:30 am</span>
                <span>{locale === 'es' ? 'Tarima: Dance Sould Studio 21' : 'Stage: Dance Sould Studio 21'}</span>
              </div>
              <div className="flex flex-col sm:flex-row sm:items-center gap-1 sm:gap-3">
                <span className="bg-[#E0A83A] text-[#161210] rounded-sm px-2 py-1 font-bold text-xs sm:text-sm w-fit">12:00 pm</span>
          ...
          {/* Domingo 24 de agosto */}
           <div className="bg-[#1E1813] border border-[#3A2E24] rounded-sm shadow-[0_8px_24px_-12px_rgba(0,0,0,0.4)] p-4 sm:p-6">
             ...
             <div className="grid gap-3 text-sm sm:text-base">
               <div className="flex flex-col sm:flex-row sm:items-center gap-1 sm:gap-3">
                 <span className="bg-[#E0A83A] text-[#161210] rounded-sm px-2 py-1 font-bold text-xs sm:text-sm w-fit">10:00 am</span>
                 <span className="font-semibold text-[#D9563B]">{locale === 'es' ? 'Desfile de Boyeros desde Casa Pastoral' : 'Oxcart Parade from Pastoral House'}</span>
               </div>
               <div className="flex flex-col sm:flex-row sm:items-center gap-1 sm:gap-3">
                 <span className="bg-[#E0A83A] text-[#161210] rounded-sm px-2 py-1 font-bold text-xs sm:text-sm w-fit">12:00 pm</span>
                 <span className="font-semibold text-[#D9563B]">{locale === 'es' ? 'Pasada Desfile de Boyeros frente al templo parroquial' : 'Oxcart Parade passing in front of the parish temple'}</span>
               </div>
               <div className="flex flex-col sm:flex-row sm:items-center gap-1 sm:gap-3">
                 <span className="bg-[#E0A83A] text-[#161210] rounded-sm px-2 py-1 font-bold text-xs sm:text-sm w-fit">2:00 pm</span>
           ...
           <div className="bg-[#1E1813] border border-[#3A2E24] rounded-sm shadow-[0_8px_24px_-12px_rgba(0,0,0,0.4)] p-4 sm:p-6">
             ...
             <div className="grid gap-3 text-sm sm:text-base">
               ...
               <div className="flex flex-col sm:flex-row sm:items-center gap-1 sm:gap-3">
                 <span className="bg-[#E0A83A] text-[#161210] rounded-sm px-2 py-1 font-bold text-xs sm:text-sm w-fit">3:00 pm</span>
           ...
           <div className="bg-[#1E1813] border border-[#3A2E24] rounded-sm shadow-[0_8px_24px_-12px_rgba(0,0,0,0.4)] p-4 sm:p-6">
             ...
             <div className="grid gap-3 text-sm sm:text-base">
               ...
               <div className="flex flex-col sm:flex-row sm:items-center gap-1 sm:gap-3">
                 <span className="bg-[#E0A83A] text-[#161210] rounded-sm px-2 py-1 font-bold text-xs sm:text-sm w-fit">7:30 pm</span>
           ...
           <div className="bg-[#1E1813] border border-[#3A2E24] rounded-sm shadow-[0_8px_24px_-12px_rgba(0,0,0,0.4)] p-4 sm:p-6">
             ...
             <div className="grid gap-3 text-sm sm:text-base">
               <div className="flex flex-col sm:flex-row sm:items-center gap-1 sm:gap-3">
                 <span className="bg-[#E0A83A] text-[#161210] rounded-sm px-2 py-1 font-bold text-xs sm:text-sm w-fit">10:30 am</span>
                 <span>{locale === 'es' ? 'Tarima: Presentación del Kinder El Grillito' : 'Stage: Kinder El Grillito Presentation'}</span>
               </div>
               <div className="flex flex-col sm:flex-row sm:items-center gap-1 sm:gap-3">
                 <span className="bg-[#E0A83A] text-[#161210] rounded-sm px-2 py-1 font-bold text-xs sm:text-sm w-fit">11:00 am</span>
               ...
               <div className="flex flex-col sm:flex-row sm:items-center gap-1 sm:gap-3">
                 <span className="bg-[#E0A83A] text-[#161210] rounded-sm px-2 py-1 font-bold text-xs sm:text-sm w-fit">8:30 pm</span>
           ...
           <div className="bg-[#1E1813] border border-[#3A2E24] rounded-sm shadow-[0_8px_24px_-12px_rgba(0,0,0,0.4)] p-4 sm:p-6">
             ...
             <div className="grid gap-3 text-sm sm:text-base">
               ...
               <div className="flex flex-col sm:flex-row sm:items-center gap-1 sm:gap-3">
                 <span className="bg-[#E0A83A] text-[#161210] rounded-sm px-2 py-1 font-bold text-xs sm:text-sm w-fit">4:30 pm</span>
           ...
           <div className="bg-[#1E1813] border border-[#3A2E24] rounded-sm shadow-[0_8px_24px_-12px_rgba(0,0,0,0.4)] p-4 sm:p-6">
             ...
             <div className="grid gap-3 text-sm sm:text-base">
               <div className="flex flex-col sm:flex-row sm:items-center gap-1 sm:gap-3">
                 <span className="bg-[#E0A83A] text-[#161210] rounded-sm px-2 py-1 font-bold text-xs sm:text-sm w-fit">1:00 pm</span>
               ...
               <div className="flex flex-col sm:flex-row sm:items-center gap-1 sm:gap-3">
                 <span className="bg-[#E0A83A] text-[#161210] rounded-sm px-2 py-1 font-bold text-xs sm:text-sm w-fit">3:30 pm</span>
          ...
          <div className="bg-[#1E1813] rounded-sm shadow-[0_8px_24px_-12px_rgba(0,0,0,0.4)] p-4 sm:p-6 border-2 border-[#D9563B]/60">
            <h3 className="font-display text-xl sm:text-2xl font-semibold mb-4 text-[#D9563B] border-b border-[#3A2E24] pb-2">
              {locale === 'es' ? 'Sábado 30 de agosto - ENTRADA DE LOS SANTOS' : 'Saturday, August 30 - ENTRANCE OF THE SAINTS'}
            </h3>
            <div className="grid gap-3 text-sm sm:text-base">
              <div className="flex flex-col sm:flex-row sm:items-center gap-1 sm:gap-3">
                <span className="bg-[#D9563B] text-[#F1E7D6] rounded-sm px-2 py-1 font-bold text-xs sm:text-sm w-fit">9:00 am</span>
                <span className="font-bold text-[#D9563B]">{locale === 'es' ? '🎉 ENTRADA DE LOS SANTOS 🎉' : '🎉 ENTRANCE OF THE SAINTS 🎉'}</span>
              </div>
              <div className="flex flex-col sm:flex-row sm:items-center gap-1 sm:gap-3">
                <span className="bg-[#E0A83A] text-[#161210] rounded-sm px-2 py-1 font-bold text-xs sm:text-sm w-fit">11:00 am</span>
          ...
          <div className="bg-[#1E1813] rounded-sm shadow-[0_8px_24px_-12px_rgba(0,0,0,0.4)] p-4 sm:p-6 border-2 border-[#E0A83A]/60">
            <h3 className="font-display text-xl sm:text-2xl font-semibold mb-4 text-[#E0A83A] border-b border-[#3A2E24] pb-2">
              {locale === 'es' ? 'Domingo 31 de agosto - DÍA PATRONAL' : 'Sunday, August 31 - PATRONAL DAY'}
            </h3>
            <div className="grid gap-3 text-sm sm:text-base">
              <div className="flex flex-col sm:flex-row sm:items-center gap-1 sm:gap-3">
                <span className="bg-[#E0A83A] text-[#161210] rounded-sm px-2 py-1 font-bold text-xs sm:text-sm w-fit">6:00 am</span>
                <span className="font-semibold text-[#F1E7D6]">{locale === 'es' ? '🏃‍♂️ Carrera de Atletismo 12va Edición' : '🏃‍♂️ 12th Edition Athletics Race'}</span>
              </div>
              <div className="flex flex-col sm:flex-row sm:items-center gap-1 sm:gap-3">
                <span className="bg-[#E0A83A] text-[#161210] rounded-sm px-2 py-1 font-bold text-xs sm:text-sm w-fit">10:15 am</span>
                <span className="font-bold text-[#F1E7D6]">{locale === 'es' ? '⛪ Procesión con San Ramón alrededor del parque MAB' : '⛪ Procession with San Ramón around MAB park'}</span>
              </div>
              <div className="flex flex-col sm:flex-row sm:items-center gap-1 sm:gap-3">
                <span className="bg-[#E0A83A] text-[#161210] rounded-sm px-2 py-1 font-bold text-xs sm:text-sm w-fit">11:00 am</span>
                <span className="font-bold text-[#F1E7D6]">{locale === 'es' ? '⛪ Santa Misa Patronal — Presidio Monseñor Bartolomé Bulgués Oller' : '⛪ Patronal Holy Mass — Presided by Monsignor Bartolomé Bulgués Oller'}</span>
              </div>
              <div className="flex flex-col sm:flex-row sm:items-center gap-1 sm:gap-3">
                <span className="bg-[#E0A83A] text-[#161210] rounded-sm px-2 py-1 font-bold text-xs sm:text-sm w-fit">7:00 pm</span>
          ...
          {/* Nota especial */}
          <div className="bg-[#1E1813] border-l-4 border-[#E0A83A] p-4 rounded-sm">
            <p className="text-sm sm:text-base text-[#F1E7D6]">
              <strong className="text-[#E0A83A]">{locale === 'es' ? 'Nota especial:' : 'Special note:'}</strong> {locale === 'es' ? 'Gran rifa del carro Toyota BZ4x, raspado de ollas y comparsa Fuerza Latina Ramonense.' : 'Grand raffle of Toyota BZ4x car, pot scratching and Fuerza Latina Ramonense parade.'}
            </p>
          </div>
        </div>

        {/* Handmade Art participation section */}
        <div className="bg-[#1E1813] border border-[#3A2E24] p-6 rounded-sm mb-8">
          <h3 className="font-display text-2xl font-semibold mb-4 text-[#F1E7D6]">{locale === 'es' ? 'Handmade Art en las Fiestas' : 'Handmade Art at the Festivities'}</h3>
          <p className="mb-4 text-[#C9BBA5]">
          ...
          <ul className="list-disc pl-6 mb-4 space-y-2 text-[#C9BBA5]">
        ...
        <div className="bg-[#1E1813] border border-[#3A2E24] rounded-sm p-6 shadow-[0_8px_24px_-12px_rgba(0,0,0,0.4)]">
          <h3 className="font-display text-2xl font-semibold mb-4 text-[#F1E7D6]">{locale === 'es' ? 'Ubicación y Contacto' : 'Location and Contact'}</h3>
          <p className="mb-4 text-[#C9BBA5]">
          ...
          <p className="text-[#C9BBA5]">
            ...
            <a href="mailto:info@handmadeart.store" className="text-[#E0A83A] hover:text-[#F3C56B] underline">
            ...
            <a
              ...
              className="text-[#E0A83A] hover:text-[#F3C56B] underline"
            >
              +506 8585 0000
            </a>
          </p>
